        ...
        <motion.div className='footer' variants={variants} initial="initial" whileInView="animate">
            <motion.div className='footer-content' variants={variants}>
                ...
                <div className='footer-contact'>
                    <h2>Telefone</h2>
                    <span>+55 11 97658-9382</span>
                </div>
            </motion.div>
            <div className='footer-form'>
                <motion.div className='tel-icon' initial={{opacity: 1}} whileInView={{opacity:0}} transition={{ delay: 3, duration: 3}}> 
